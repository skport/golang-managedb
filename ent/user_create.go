...
func (uc *UserCreate) SetUsergroupID(i int) *UserCreate {
	uc.mutation.SetUsergroupID(i)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.UsergroupID(); !ok {
		return &ValidationError{Name: "usergroup_id", err: errors.New(`ent: missing required field "User.usergroup_id"`)}
	}
	if _, ok := uc.mutation.CreatedAt(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.UsergroupID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeInt,
			Value:  value,
